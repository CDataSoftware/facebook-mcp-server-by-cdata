...
:heavy_exclamation_mark: This project builds a read-only MCP server. For full read, write, update, delete, and action capabilities and a simplified setup, check out our free [CData MCP Server for Facebook (beta)](https://www.cdata.com/download/download.aspx?sku=RBZM-V&type=beta). 
## Purpose
...
```json
{
    ...
    "method": "tools/call",
    "params": {
        "name": "facebook_get_tables",
        "arguments": {}
    }
}
```

#### facebook_get_columns
```json
{
    "jsonrpc": "2.0",
    "id": 2,
